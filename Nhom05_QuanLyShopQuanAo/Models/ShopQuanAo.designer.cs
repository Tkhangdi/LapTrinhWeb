...
namespace Nhom05_QuanLyShopQuanAo.Models
{
    ...
    partial void InsertSize_SanPham(Size_SanPham instance);
    partial void UpdateSize_SanPham(Size_SanPham instance);
    partial void DeleteSize_SanPham(Size_SanPham instance);
    ...
    partial void DeleteThuongHieu(ThuongHieu instance);
		...
		public System.Data.Linq.Table<Size_SanPham> Size_SanPhams
		{
			get
			{
				return this.GetTable<Size_SanPham>();
			}
		}
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnMaLSNHChanging(string value);
    partial void OnMaLSNHChanged();
    ...
    partial void OnMaNhanVienChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MaLSNH", DbType="VarChar(50) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string MaLSNH
		{
			get
			{
				return this._MaLSNH;
			...
			set
			{
				if ((this._MaLSNH != value))
				{
					this.OnMaLSNHChanging(value);
					this.SendPropertyChanging();
					this._MaLSNH = value;
					this.SendPropertyChanged("MaLSNH");
					this.OnMaLSNHChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MaSP", DbType="VarChar(50)")]
		public string MaSP
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NhanVien_LichSuNhapHang", Storage="_NhanVien", ThisKey="MaNhanVien", OtherKey="TenDangNhap", IsForeignKey=true)]
		public NhanVien NhanVien
		{
			get
			{
			...
			set
			{
							...
							|| (this._NhanVien.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._MaNhanVien = value.TenDangNhap;
					}
					else
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SanPham_LichSuNhapHang", Storage="_SanPham", ThisKey="MaSP", OtherKey="MaSanPham", IsForeignKey=true)]
		public SanPham SanPham
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Size_LichSuNhapHang", Storage="_Size", ThisKey="MaSize", OtherKey="MaSize", IsForeignKey=true)]
		public Size Size
		{
			get
			{
    ...
    partial void OnChucVuChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NhanVien_LichSuNhapHang", Storage="_LichSuNhapHangs", ThisKey="TenDangNhap", OtherKey="MaNhanVien")]
	...
	public partial class SanPham : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Size_SanPham> _Size_SanPhams;
    ...
    partial void OnAnhChanged();
		...
		public SanPham()
		{
			...
			this._LichSuNhapHangs = new EntitySet<LichSuNhapHang>(new Action<LichSuNhapHang>(this.attach_LichSuNhapHangs), new Action<LichSuNhapHang>(this.detach_LichSuNhapHangs));
			this._SanPhamMaGiamGias = new EntitySet<SanPhamMaGiamGia>(new Action<SanPhamMaGiamGia>(this.attach_SanPhamMaGiamGias), new Action<SanPhamMaGiamGia>(this.detach_SanPhamMaGiamGias));
			this._Size_SanPhams = new EntitySet<Size_SanPham>(new Action<Size_SanPham>(this.attach_Size_SanPhams), new Action<Size_SanPham>(this.detach_Size_SanPhams));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SanPham_LichSuNhapHang", Storage="_LichSuNhapHangs", ThisKey="MaSanPham", OtherKey="MaSP")]
		public EntitySet<LichSuNhapHang> LichSuNhapHangs
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SanPham_Size_SanPham", Storage="_Size_SanPhams", ThisKey="MaSanPham", OtherKey="MaSanPham")]
		public EntitySet<Size_SanPham> Size_SanPhams
		{
			get
			{
				return this._Size_SanPhams;
			}
			set
			{
				this._Size_SanPhams.Assign(value);
			}
		}
		...
		private void attach_Size_SanPhams(Size_SanPham entity)
		{
			this.SendPropertyChanging();
			entity.SanPham = this;
		}
		
		private void detach_Size_SanPhams(Size_SanPham entity)
		{
			this.SendPropertyChanging();
			entity.SanPham = null;
		}
    ...
    partial void OnMoTaSizeChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Size_LichSuNhapHang", Storage="_LichSuNhapHangs", ThisKey="MaSize", OtherKey="MaSize")]
		public EntitySet<LichSuNhapHang> LichSuNhapHangs
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Size_Size_SanPham", Storage="_Size_SanPhams", ThisKey="MaSize", OtherKey="MaSize")]
		public EntitySet<Size_SanPham> Size_SanPhams
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Size_SanPham")]
	public partial class Size_SanPham : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnTrangThaiChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SanPham_Size_SanPham", Storage="_SanPham", ThisKey="MaSanPham", OtherKey="MaSanPham", IsForeignKey=true)]
		public SanPham SanPham
		{
			get
			{
			...
			set
			{
							...
							|| (this._SanPham.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._SanPham.Entity = null;
						previousValue.Size_SanPhams.Remove(this);
					}
					this._SanPham.Entity = value;
					if ((value != null))
					{
						value.Size_SanPhams.Add(this);
						this._MaSanPham = value.MaSanPham;
					}
					else
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Size_Size_SanPham", Storage="_Size", ThisKey="MaSize", OtherKey="MaSize", IsForeignKey=true)]
		public Size Size
		{
			get
			{
